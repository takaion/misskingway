...
export class HttpRequestService {
	...
	@bindThis
	public async getJson<T = unknown>(url: string, accept = 'application/json, */*', headers?: Record<string, string>, isLocalAddressAllowed = false, timeout: number = 5000): Promise<T> {
		const res = await this.send(url, {
			method: 'GET',
