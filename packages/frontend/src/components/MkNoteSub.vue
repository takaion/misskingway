...
<div v-else-if="!muted" :class="[$style.root, { [$style.children]: depth > 1 }, note.visibility === 'home' ? $style.home : note.visibility === 'followers' ? $style.followers : note.visibility === 'specified' ? $style.specified : '']">
